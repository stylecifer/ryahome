...
// add classes to ul sub-menus
  function display_element( $element, &$children_elements, $max_depth, $depth=0, $args, &$output )
	...
	function start_lvl( &$output, $depth ) {
		...
		$out_div = ($depth == 0 ? '<div class="second"><div class="inner"><div class="inner_arrow"></div><div class="inner2">' : '');
	...
	// add main/sub classes to li's and links
	 function start_el( &$output, $item, $depth, $args ) {
		...
		if ((($item->current && $depth == 0) ||  ($item->current_item_ancestor && $depth == 0)) && ($qode_options_passage['page_transitions'] == "0")):
...
/* Custom WP_NAV_MENU function for top navigation - TYPE 3 */
