...
function image_with_text_over($atts, $content = null) {
	...
	if($link != ""){
		$html .= "<a href='".$link."' target='".$target."'><img src='".$image_link."' alt=''><span class='image_hover' style='background-color: ".$background_color.";'></span><span class='text_holder'><span class='text_inner'><h4 style='color: ".$title_color.";'>".$title."</h4><p style='color: ".$text_color.";'>".$text."</p></span></span></a></div>";
	} else {
		$html .= "<img src='".$image_link."' alt=''><span class='image_hover' style='background-color: ".$background_color.";'></span><span class='text_holder'><span class='text_inner'><h4 style='color: ".$title_color.";'>".$title."</h4><p style='color: ".$text_color.";'>".$text."</p></span></span></div>";
	}
